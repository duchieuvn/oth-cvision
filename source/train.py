...
train_data = utils.DynamicNucDataset(root=config['data_root'], subset=config['train_dn'])
val_data   = utils.DynamicNucDataset(root=config['data_root'], subset=config['val_dn'])
